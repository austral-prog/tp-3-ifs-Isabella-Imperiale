def calculator():
    ...
    if numero_1 and numero_2 and operacion == "+":
        print("Resultado: " + str(numero_1 + numero_2))
    elif numero_1 and numero_2 and operacion == "-":
        print("Resultado: " + str(numero_1 - numero_2))
    elif numero_1 and numero_2 and operacion == "*":
        print("Resultado: " + str(numero_1 * numero_2))
    elif numero_1 and numero_2 != 0 and operacion == "/":
        print("Resultado: " + str(numero_1 / numero_2))
    elif numero_1 and numero_2 == 0 and operacion == "/":
